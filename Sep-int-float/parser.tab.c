...
static const char *const yytname[] =
{
  ...
  "SUBTRACT", "NEWLINE", "MULTIPLY", "DIVIDE", "LPAREN", "RPAREN", "EQUAL",
  "MODULO", "$accept", "lines", "expr", "term", "factor", YY_NULLPTR
};
...
{
      -6,     0,    -6,    -5,    -6,    -6,     2,    10,    11,    -6,
      -6,     3,     2,     2,    -6,     2,     2,    -6,    11,    11,
      -6,    -6
};
...
{
       2,     0,     1,     0,    11,    12,     0,     0,     7,    10,
       4,     0,     0,     0,     3,     0,     0,    13,     5,     6,
       9,     8
};
...
{
       2,     3,    10,     4,     5,     4,     5,    11,    12,    13,
       6,     0,     6,     0,    17,    12,    13,    14,     0,    15,
      16,    18,    19,    20,    21
};
...
{
       0,    15,     0,     1,     3,     4,    10,    16,    17,    18,
       7,    16,     5,     6,     7,     8,     9,    11,    17,    17,
      18,    18
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 3: /* lines: lines expr NEWLINE  */
#line 37 "parser.y"
                          {
              if((yyvsp[-1].dval) == (double)((int)(yyvsp[-1].dval))){           
                printf("Result: %d\n", (int)(yyvsp[-1].dval));
              }else{
                printf("Result: %.3f\n", (yyvsp[-1].dval));
              }           
...
#line 1105 "parser.tab.c"
  ...
  case 6: /* expr: expr SUBTRACT term  */
#line 50 "parser.y"
                         {(yyval.dval) = (yyvsp[-2].dval) - (yyvsp[0].dval);}
